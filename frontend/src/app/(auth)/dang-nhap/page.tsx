      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 disabled:opacity-60"
          >
            <GoogleIcon />
          ...
          <button
            ...
            disabled={oauthLoading !== null}
            className="flex items-center justify-center gap-2 rounded-md bg-[#1877F2] px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-[#166FE5] disabled:opacity-60"
          >
            <FacebookIcon />
